...
export class CustomersComponent implements OnInit {
  ...
  openDeleteCustomerModal(customer: ManagerCustomerResponse): void {
    ...
    if (instance && instance.confirm) {
      instance.confirm.subscribe(() => this.deleteCustomer(customer));
    }
  }

  private deleteCustomer(customer: ManagerCustomerResponse): void {
    this.isLoading = true;
    this.cus.deleteCustomer(customer.id).subscribe({
      next: () => {
